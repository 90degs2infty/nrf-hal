...
macro_rules! define_prescaler {
    ($num:literal) => {
        paste::paste! {
            ...
            #[doc = "See Nordic's docs on the [`PRESCALER`](https://infocenter.nordicsemi.com/topic/ps_nrf52840/timer.html?cp=5_0_0_5_29_4_12#register.PRESCALER) register for details."]
            pub struct [<P $num>];
